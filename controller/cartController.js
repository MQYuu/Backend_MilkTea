...
const getCart = async (req, res) => {
    try {
        const { userId } = req.params; // cách 1
        //const userId = req.params.userId // cách 2
        
        //console.log(req.params); // Kiểm tra toàn bộ req.params
        //console.log(req.params.userId); // Lấy giá trị userId từ URL
...
// Thêm sản phẩm vào giỏ hàng của user thông qua userIduserId
